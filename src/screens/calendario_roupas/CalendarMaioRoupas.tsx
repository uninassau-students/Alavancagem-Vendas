...
import { dailyTasksMaio } from "../../lib/taskRoupas";

interface Day {
  dateString: string;
}

function CalendarMaioRoupas() {
  ...
  const initialDate = "2023-05-01";
  const initialTask = dailyTasksMaio[initialDate] || "Nada a fazer hoje";
...
export default CalendarMaioRoupas;
